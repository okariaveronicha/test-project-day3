...
WebUI.setText(findTestObject('Object Repository/Shop tools - register/input__username'), 'okariaveronicha12')

WebUI.setText(findTestObject('Object Repository/Shop tools - register/input__email'), 'okariasimanjuntak32@gmail.com')
