...
//
//Mobile.tap(findTestObject('Bulk-Upload-Retailer/TC_MO_Nama-dengan-angka/android.widget.CheckedTextView - Rekanan'),
//	0)
//
//Mobile.tap(findTestObject('Bulk-Upload-Retailer/TC_MO_Nama-dengan-angka/android.widget.TextView - Retailer'),
//	0)
//
//Mobile.tap(findTestObject('Bulk-Upload-Retailer/TC_MO_Nama-dengan-angka/android.widget.Button -  Tambah Retailer'),
//	0)
//
//Mobile.tap(findTestObject('Bulk-Upload-Retailer/TC_MO_Nama-dengan-angka/android.widget.TextView - Tambah Massal'),
//	0)

Mobile.tap(findTestObject('Bulk-Upload-Retailer/TC_MO_Nama-dengan-angka/android.widget.Button - Pilih File'),
	0)
